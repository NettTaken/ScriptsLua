local keystatus = game:HttpGet("https://pastebin.com/raw/zaYmJXSQ")
if _G.key == keystatus then
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Consistt/Ui/main/UnLeaked"))()
library.rank = "developer"
--local Wm = library:Watermark("Forsaken Tower Defense | UPD" .. gameVersion ..  " | " .. library:GetUsername())
local Wm = library:Watermark("Dead Rails Tower Defense")
...
local LoadingXSX = Notif:Notify("Loading Dead Rails Tower Defense, please be patient.", 3, "information") -- notification, alert, error, success, information

library.title = "Dead Rails Tower Defense"

library:Introduction()
local Init = library:Init()

local Tab1 = Init:NewTab("Game")
local Tab2 = Init:NewTab("Lobby")
local Tab4 = Init:NewTab("Misc")
local Tab3 = Init:NewTab("Credits")


--- GAME TAB ---
local toSum
local Textbox1 = Tab1:NewTextbox("Type Tower", "", "Tower", "all", "medium", true, false, function(val)
    toSum = val
end)
Textbox1:Hide()
local Selector1 = Tab1:NewSelector("Choose Tower", "Tower List", {"Noob", "CowBoy", "Dual-Sabler", "Zombie", "ShotGunner", "Doctor", "Vampire", "Sniper", "WereWolf", "Turret", "Knifer", "Shocked WereWolf", "Horse", "Sigma-CowBoy"}, function(val)
    toSum = val
end)
local Button1 = Tab1:NewButton("Summon Tower", function()
    game:GetService("ReplicatedStorage").Functions.SpawnTower:InvokeServer(toSum, CFrame.new(game.Players.LocalPlayer.Character.HumanoidRootPart.Position) * CFrame.Angles(-0, 0, -0))
end)
...
--- LOBBY TAB ---
local Textbox2 = Tab2:NewTextbox("Change Name", "", "Name", "all", "medium", true, false, function(val)
    if val == "" then
	game.Players.LocalPlayer.Character.Head.Nametag.PlayerName.Text = game.Players.LocalPlayer.Name
    else
   	game.Players.LocalPlayer.Character.Head.Nametag.PlayerName.Text = val
	end
end)
local Textbox3 = Tab2:NewTextbox("Change Title", "", "Title", "all", "medium", true, false, function(val)
	game.Players.LocalPlayer.Character.Head.Nametag.Title.Visible = true
   	game.Players.LocalPlayer.Character.Head.Nametag.Title.Text = val
end)
local Button3 = Tab2:NewButton("Get items", function()
...
--- CREDITS TAB ---
local Label1 = Tab3:NewLabel("Script creator | xzen0x")
--local Label2 = Tab3:NewLabel("Game creator | Lox_su1")
--local Label3 = Tab3:NewLabel("My skibidi sigma student | why?")
--- CREDITS TAB ---

--- MISC TAB ---
local Button2 = Tab4:NewButton("Rejoin", function()
...
local FinishedLoading = Notif:Notify("Loaded Dead Rails Tower Defense", 4, "success")
end
-- // FUNCTION DOCS: 
--[[
    MAIN COMPONENT DOCS:
